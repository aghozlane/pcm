...
We apply the model estimated on the discovery set to your dataset. The obtained classes are saved in a text file.
...
DT::datatable(prediction,options = list(pageLength=50, scrollX='400px'))
```
